...
export default function Home() {
    const [modelPath, setModelPath] = useState('/models/Tshirt_Oversized.glb');
    const [modelColor, setModelColor] = useState('#FFFFFF');
    const [decalImage, setDecalImage] = useState<string | null>(null);
    // const [decalImage, setDecalImage] = useState<string | null>('/textures/Oversized_Baked.jpg');
    ...
    // Take screenshot (inspired by 3dmockups.app)
    ...
    return (
        <div className="relative h-screen w-screen overflow-hidden font-sans">
            ...
            {/* Top Right Action Buttons (inspired by 3dmockups.app) */}
            ...
            {/* Bottom Toolbar (inspired by 3dmockups.app) */}
            ...
            {/* Color Picker Panel (inspired by 3dmockups.app) */}
            {activeTool === 'color' && (
            ...
            {/* Edit Panel - Image Upload (inspired by 3dmockup.co) */}
            {activeTool === 'edit' && (
