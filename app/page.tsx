                    ...
                    {models.map((model, index) => (
                        ...
                        >
                            ...
                            <div className="p-6 sm:p-8">
                                {/* Icon */}
                                <div className="text-5xl sm:text-6xl md:text-7xl mb-3 sm:mb-4 text-center transform group-hover:scale-110 transition-transform">
                                    {model.icon}
                                </div>

                                {/* Title */}
                                <h3 className="text-xl sm:text-2xl font-bold text-white text-center mb-1.5 sm:mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-purple-500 group-hover:bg-clip-text transition-all">
                                    {model.name}
                                </h3>

                                {/* File Name */}
                                <p className="text-slate-400 text-xs sm:text-sm text-center font-mono break-all">
                                    {model.fileName}
                                </p>
                                ...
                                <div className="mt-4 sm:mt-6 flex items-center justify-center gap-2 text-slate-300 group-hover:text-white transition-colors">
